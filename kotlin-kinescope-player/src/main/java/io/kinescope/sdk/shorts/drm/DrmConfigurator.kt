...
class DrmConfigurator(private val context: Context) {
        ...
        Thread {
            ...
            try {
                ...
                if (keySetId != null) {
                    ...
                    Log.d("drmConfigurator_downloadOfflineLicense", "Offline license saved for $contentId")
                }
            } catch (e: Exception) {
                Log.e("downloadOfflineLicense", "Failed to download license for $contentId", e)
            } finally {
                callback(keySetId)
            }
        }.start()
    ...
    // --- Хранение лицензий ---
     ...
     fun saveOfflineLicenseToStorage(contentId: String, keySetId: ByteArray) {
        try {
            ...
            Log.e("drmConfigurator_saveOfflineLicenseToStorage", "Error saving license", e)
        }
    }
    ...
    fun loadOfflineLicenseFromStorage(contentId: String): ByteArray? {
        return try {
            ...
            Log.e("drmConfigurator_loadOfflineLicenseFromStorage", "Error loading license", e)
            null
        }
    }
    ...
    fun clearAllOfflineLicenses() {
        try {
            ...
            Log.d("drmConfigurator_clearAllOfflineLicenses", "All licenses cleared")
        } catch (e: Exception) {
            Log.e("drmConfigurator_clearAllOfflineLicenses", "Error clearing licenses", e)
        }
    }
}
