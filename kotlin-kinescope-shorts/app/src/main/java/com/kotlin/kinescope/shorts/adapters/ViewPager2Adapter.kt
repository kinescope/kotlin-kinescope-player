...
class ViewPager2Adapter(
    ...
    private var videoPreloader: com.kotlin.kinescope.shorts.managers.VideoPreloader? = null

    fun attachToViewPager(viewPager2: ViewPager2) {
        this.viewPager2 = viewPager2

        val playerFactory = com.kotlin.kinescope.shorts.managers.PlayerFactory(context)
        videoPreloader = com.kotlin.kinescope.shorts.managers.VideoPreloader(context, playerFactory)
