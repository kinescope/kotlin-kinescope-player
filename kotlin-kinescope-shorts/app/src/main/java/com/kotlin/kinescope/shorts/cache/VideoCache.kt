package com.kotlin.kinescope.shorts.cache
...
object VideoCache {
    ...
    private fun getMaxCacheSize(): Long {
        ...
        val isWeakDevice = maxMemory < 2048 || 
                          processorCount < 4 ||
                          (android.os.Build.BRAND.equals("honor", ignoreCase = true) && maxMemory < 3072) ||
                          (android.os.Build.BRAND.equals("huawei", ignoreCase = true) && maxMemory < 3072)
