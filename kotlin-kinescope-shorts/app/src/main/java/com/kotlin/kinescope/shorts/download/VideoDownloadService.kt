...
class VideoDownloadService : DownloadService(
    ...
    override fun getDownloadManager(): androidx.media3.exoplayer.offline.DownloadManager {
        return io.kinescope.sdk.shorts.download.VideoDownloadManager.getDownloadManager(this)
    }
    ...
    private fun buildNotification(
        ...
        if (activeDownloads.isNotEmpty()) {
            ...
            val (percent, _) = io.kinescope.sdk.shorts.download.VideoDownloadManager.getDownloadProgress(download)
